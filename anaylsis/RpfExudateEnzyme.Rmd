...
rm(list=ls())
getwd()
setwd("~/../Github/TransgenicRpfArabiosis")
```
...
```{r}
setwd("~/../Github/TransgenicRpfArabiosis/data")
...
# Y axis labels
mtext(expression('Absorabance'), side = 2,
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1.25, las = 1,
     labels = c("Substrate", "Rpf", "Col-0", "T1", "T4"), at = c(1, 2, 3, 4, 5))
